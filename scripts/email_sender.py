...
def build_email(contact: dict) -> tuple[str, str]:
    ...
    # ---- B2B CORPORATE (multinationales FR -- RH + relocation Tokyo) ----
        ...
        body = (
            ...
            f"Je traite regulierement avec les operateurs de logement meuble et de share house a Tokyo "
            f"(share houses, appartements meubles, maisons familiales, 40k-300k JPY/mois) et je confirme "
            f"les disponibilites avant de les proposer. J'accompagne le processus entier en francais, "
            f"de la recherche jusqu'a la signature du bail.\n\n"
