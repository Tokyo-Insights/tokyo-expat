...
export const PROPERTY_TYPES: TypeInfo[] = [
  ...
  },
  {
    ...
    icon: '🏢',
    descFr: "Studio à 2LDK entièrement meublés. La formule la plus demandée par les expatriés. Sans garant possible. Je négocie le loyer directement avec le propriétaire.",
    descEn: 'Studio to 2LDK fully furnished. Most requested by expats. No guarantor possible. I negotiate rent directly with the landlord.',
    priceRange: { min: 75000, max: 280000 },
    features: ['Sans garant (selon profil)', 'Meublé complet', 'Internet inclus (selon)', 'Durée min. 1 mois', 'Contrat négocié'],
    featuresEn: ['No guarantor (profile dependent)', 'Fully furnished', 'Internet included (varies)', 'Min. 1 month', 'Negotiated contract'],
    minStayFr: 'À partir de 1 mois',
    minStayEn: 'From 1 month',
  },
  {
    ...
    nameEn: 'House / Family',
    icon: '🏡',
    descFr: "Pour les familles et les groupes. 3-4 chambres, jardin, parking. Quartiers résidentiels proches des écoles internationales (EFIJ, Lycée Franco-Japonais).",
    descEn: 'For families and groups. 3-4 bedrooms, garden, parking. Residential areas near international schools (EFIJ, Franco-Japanese High School).',
...
export const ZONES: ZoneData[] = [
  ...
  },
  {
    ...
    highlights: ['Hiroo / Roppongi', 'Quartier ambassades', 'Corporate'],
    highlightsEn: ['Hiroo / Roppongi', 'Embassy district', 'Corporate expats'],
  },
  {
    ward: 'Bunkyo-ku',
    nameEn: 'Bunkyo',
  ...
  },
  {
    ...
    highlights: ['EFIJ proche', 'Calme', 'Grand espace'],
    highlightsEn: ['Near EFIJ', 'Quiet', 'Spacious'],
  },
  {
    ward: 'Suginami-ku',
    nameEn: 'Suginami',
    ...
    highlights: ['Koenji', 'Nakano', 'Abordable'],
    highlightsEn: ['Koenji', 'Nakano', 'Affordable'],
  },
  {
    ward: 'Musashino-shi',
    nameEn: 'Musashino',
    ...
    highlights: ['Kichijoji', 'Parc Inogashira', 'Quartier rêvé'],
    highlightsEn: ['Kichijoji', 'Inogashira Park', 'Dream neighborhood'],
  },
]
